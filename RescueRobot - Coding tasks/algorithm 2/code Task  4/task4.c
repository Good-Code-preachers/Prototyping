...
int move(char* world, int map_id) {
    ...
    if (target_index != 0) {
        ...
        if (driving_mode != 1) {
            ...
            if (world[step_n] == 'O' || world[step_n] == 'T' || world[step_n] == 'X' || world[step_n] == 't') {
            ...
            if (world[step_s] == 'O' || world[step_s] == 'T' || world[step_s] == 'X'|| world[step_s] == 't') {
            ...
            if (world[step_w] == 'O' || world[step_w] == 'T' || world[step_w] == 'X'|| world[step_w] == 't') {
                if (world[step_se] == 'O') {
            ...
            if (world[step_e] == 'O' || world[step_e] == 'T' || world[step_e] == 'X'|| world[step_e] == 't') {
                if (robox < tarx && roboy == tary) {
                    return 2;
                }
            }
        ...
        if (driving_mode != 0) {
            ...
            if (world[step_n] == '~' || world[step_n] == 'T'|| world[step_n] == 't') {
                if (robox > tarx && roboy > tary || robox == tarx && roboy > tary || robox < tarx && roboy > tary) {
                    return 1;
                }

            }
            if (world[step_s] == '~' || world[step_s] == 'T'|| world[step_s] == 't') {
                if (robox < tarx && roboy < tary || robox == tarx && roboy < tary || robox > tarx && roboy < tary) {
                    return 3;
                }
            }
            if (world[step_w] == '~' || world[step_w] == 'T'|| world[step_w] == 't') {
                if (robox > tarx && roboy == tary) {
                    return 4;
                }
            }
            if (world[step_e] == '~' || world[step_e] == 'T'|| world[step_e] == 't') {
                if (robox < tarx && roboy == tary) {
                    return 2;
                }
            }
        ...
        if (driving_mode != 1) {
            ...
            if (world[step_n] == 'O' || world[step_n] == 'T' || world[step_n] == 'X') {
                if (world[step_nw] == 'O' || world[step_nw] == world[step_ne] || world[step_ne] == 'O') {
                    if (robox > tarx && roboy > tary || robox == tarx && roboy > tary || robox < tarx && roboy > tary) {
                        return 1;
                    }
                }
        ...
        if (driving_mode != 0) {
            ...
            if (world[step_n] == '~'|| world[step_n] == 'X') {
                if (robox > tarx && roboy > tary || robox == tarx && roboy > tary || robox < tarx && roboy > tary) {
                    return 1;
                }

            }
            if (world[step_s] == '~'|| world[step_s] == 'X') {
                if (robox < tarx && roboy < tary || robox == tarx && roboy < tary || robox > tarx && roboy < tary) {
                    return 3;
                }
            }
            if (world[step_w] == '~'|| world[step_w] == 'X') {
                if (robox > tarx && roboy == tary) {
                    return 4;
                }
            }
            if (world[step_e] == '~'|| world[step_e] == 'X') {
                if (robox < tarx && roboy == tary) {
                    return 2;
                }
            }
